...
public class SendMail {
	...
	final String FROM = "이메일주소";
	final String PASS = "비밀번호";
		...
		try {
			...
			session = Session.getInstance(props, new Authenticator() {
				...
				protected PasswordAuthentication getPasswordAuthentication() {
					return new PasswordAuthentication(FROM, PASS); //이메일 패스워드
				}
			});
		} catch (Exception e) {
	...
	public void sendMail(String to, String title, String content) { //이메일정보 제목 내용
